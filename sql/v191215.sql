...
CREATE TABLE `accounts` (
  ...
  `qnumber` varchar(255)  UNIQUE NOT NULL COMMENT 'qq号码',
...
-- Records of accounts
-- ----------------------------
INSERT INTO `accounts` VALUES ('1', 1234567, '1111', null, null, null, null, null, null, '1111', null, null, '0');
INSERT INTO `accounts` VALUES ('2', 2345678, 'LISHENG', null, null, null, null, null, null, '123456', null, null, '0');
INSERT INTO `accounts` VALUES ('3', 3456789, 'hah', null, null, null, null, null, null, 'ainiya', null, null, '0');
INSERT INTO `accounts` VALUES ('4', 4567890, 'hah1', null, null, null, null, null, null, 'ainiya', null, null, '0');
...
CREATE TABLE `friends` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户唯一id',
  `origin_account` varchar(16) NOT NULL COMMENT '源账号',
  `target_account` varchar(16) NOT NULL COMMENT '目标账号',
