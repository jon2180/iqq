...
public class App {
    ...
    public static void startApplication(String... args) {
        try {
            ...
            mapper.put(MessageHeaderProto.MessageHeader.ContentType.SIGN_IN_RESP, new SignInRespController(framesManager, null));
            mapper.put(MessageHeaderProto.MessageHeader.ContentType.SIGN_ON_RESP, new SignOnRespController(framesManager, null));
            mapper.put(MessageHeaderProto.MessageHeader.ContentType.MESSAGE, new MessageReceiveController(framesManager, null));
