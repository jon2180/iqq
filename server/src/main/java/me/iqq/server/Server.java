...
//        }
        ...
        mapper.put(MessageHeaderProto.MessageHeader.ContentType.MESSAGE, (DataPacket packet, SocketChannel channel) -> {
            System.out.println("message ...");
        });
        mapper.put(MessageHeaderProto.MessageHeader.ContentType.ADD_FRIEND, (DataPacket packet, SocketChannel channel) -> {
